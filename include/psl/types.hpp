...
namespace _priv {
	...
	constexpr bool is_same_specialization_v {
	  error_out<T, "ErrorMessage: does not support the combination, likely it has more than 8 template arguments.">::
		value};
...
#define GEN_SPECIALIZATION_impl_5(i0, i1, i2, i3, i4)                                                                  \
	template <template <i0, i1, i2, i3, i4> typename T,                                                                \
			  i0 A0,                                                                                                   \
			  i1 A1,                                                                                                   \
			  i2 A2,                                                                                                   \
			  i3 A3,                                                                                                   \
...
#define GEN_SPECIALIZATION_impl_6(i0, i1, i2, i3, i4, i5)                                                              \
	template <template <i0, i1, i2, i3, i4, i5> typename T,                                                            \
			  i0 A0,                                                                                                   \
			  i1 A1,                                                                                                   \
			  i2 A2,                                                                                                   \
			  i3 A3,                                                                                                   \
...
#define GEN_SPECIALIZATION_impl_7(i0, i1, i2, i3, i4, i5, i6)                                                          \
	template <template <i0, i1, i2, i3, i4, i5, i6> typename T,                                                        \
			  i0 A0,                                                                                                   \
			  i1 A1,                                                                                                   \
			  i2 A2,                                                                                                   \
			  i3 A3,                                                                                                   \
...
#define GEN_SPECIALIZATION_impl_8(i0, i1, i2, i3, i4, i5, i6, i7)                                                      \
	template <template <i0, i1, i2, i3, i4, i5, i6, i7> typename T,                                                    \
			  i0 A0,                                                                                                   \
			  i1 A1,                                                                                                   \
			  i2 A2,                                                                                                   \
			  i3 A3,                                                                                                   \
...
#pragma endregion is_same_specialization_v
	...
	struct index_of
		: std::conditional_t<std::is_same_v<T, Y>,
							 std::conditional_t<!std::disjunction_v<std::is_same<T, Ys>...>,
												wrapped_vtype<size_t, N>,
												error_out<T,
...
inline namespace details {
	...
	template <typename T>
	concept IsStrongTypeWrapper = is_strong_wrapper_t<T>::value;
...
using bytes_t = details::strong_type_wrapper_t<size_t>;
}	 // namespace psl