...
namespace psl::config
{
	...
	/**
	 * \brief specializing the types inside for default_setting_t will change the applications behaviour
	 *
	 */
	...
	constexpr static exceptions_handling errors_strategy = specialize::errors_strategy_t<default_setting_t>::value;
	constexpr static bool exceptions					 = errors_strategy == exceptions_handling::EXCEPTIONS;
	constexpr static bool exceptions_as_asserts			 = errors_strategy == exceptions_handling::ASSERTS;

	constexpr static bool asserts = specialize::use_asserts_t<default_setting_t>::value;
	 ...
	 *
	 */
	constexpr static exceptions_handling implementation_errors_strategy =
		specialize::implementation_errors_strategy_t<default_setting_t>::value;
