...
auto array_test1 =
	suite<"array", "psl", "psl::array", "containers">(generator::array<0, 8, 128>{})
		.templates<tpack<int>, vpack<psl::dynamic_extent, 512>>() = []<typename T, typename V0>(size_t start_elements) {
